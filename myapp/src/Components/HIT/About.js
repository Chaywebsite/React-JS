     ...
     <h1 className='text-center'><span>About</span> Us</h1> 
        <div className='row'>
            <div className='col-12 col-lg-12'>
                <h5 className='h5'>"Hyderabad IT Trainings provides all software courses Classroom training & Online with 100% placements."</h5>
                <p className='p'>Hyderabad IT Trainings is a Hyderabad based IT Software Training & Recruitment Company delivering classroom and online trainings in India, USA and UK, Australia, Canada, Singapore. Being the leader in Software courses classroom training & online training sector, Hyderabad IT Trainings holds the top position in short time. Our core values are providing high quality and project oriented training at affordable fees. We offer classroom and online training on all technologies which are in high demand. All our trainers are IT professionals with rich experience.</p>
            </div>
            <div className='col-12 col-lg-4'>
              <img className='w-60' src='https://hyderabadittrainings.com/images/course/cu-2.jpg'></img>
               </div>
            <div className='col-12 col-lg-8'>
            <h5 className='h5'>Online Training</h5>
            ...
            <div className='col-12 col-lg-8'>
            <h5 className='h5'>Offline Training</h5>
            ...
            <div className='col-12 col-lg-4'>
              <img className='w-60' src='https://hyderabadittrainings.com/images/course/cu-5.jpg'></img>
            </div>
            <div className='col-12 col-lg-12 col-sm-8'>
